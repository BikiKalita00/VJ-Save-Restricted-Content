...
bot_token = environ.get("TOKEN", "7235803775:AAGuWywuvPhaVteZpfGISV0u2j5GYpnFTYw") 
api_hash = environ.get("HASH", "7cdeddb40be039b3367f701fb95f81fe") 
api_id = int(environ.get("ID", "23625201"))
